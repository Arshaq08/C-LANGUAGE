...
void posi_vote(){
	...
	printf("3.VIDHI\n");
	printf("4.HARSHA\n");
	printf("VOTING DAY IS 24-04-2023\nVOTING TIME IS 10 AM TO 6PM\n");
...
void displayresult(){
    ...
    {
	printf("ARSHAQ LEADING");}
    else if (c2>c3 && c2>c4 && c2 >c1)
    {
	printf("JASHWANTH LEADING");}
    else if(c3>c4 && c3>c2 && c3 >c1)
    {
	printf("VIDHI LEADING");}
    else if(c4>c1 && c4>c2 && c4>c3)
    {
	printf("HARSHA LEADING");}
    else
...
int main(){
	...
	case 1:
		...
		if(v.age>=18){
			...
			printf("YOU AARE NOT ELIGIBLE TO VOTE\n");
		}
		break;
	case 2:
	login();
